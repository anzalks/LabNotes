...
CKEDITOR.editorConfig = function(config) {
  ...
  config.extraPlugins = 'image,button,toolbar,notificationaggregator,notification,filetools,dialogui,dialog,clipboard,lineutils,widget,uploadwidget,uploadimage,filebrowser,popup';
