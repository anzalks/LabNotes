...
//iva2k: something was going on here in older version:
					AScgiloc : AScgiloc
				});
			});
			...
			// Add a double-click handler, shortcut for the asciisvg button command
...
//							rep = '<embed type="image/svg+xml" src="'+ed.getParam('ASdloc')+'" style="'+style+'" sscr="'+decodeURIComponent(sscr)+'" />';
							rep = '<embed type="image/svg+xml" src="'+ASdloc+'" style="'+style+'" sscr="'+decodeURIComponent(sscr)+'" />';
...
//							rep = '<img src="'+ed.getParam('AScgiloc')+'?sscr='+encodeURIComponent(sscr)+'" style="'+style+'" sscr="'+decodeURIComponent(sscr)+'" />';
							rep = '<img src="'+AScgiloc+'?sscr='+encodeURIComponent(sscr)+'" style="'+style+'" sscr="'+decodeURIComponent(sscr)+'" />';
							o.content = o.content.replace(imgs[i],rep);
						}
					}
			});
...
//						ed.dom.setAttrib(n,"src",ed.getParam('AScgiloc')+'?sscr='+encodeURIComponent( ems[i].getAttribute("sscr")));
						ed.dom.setAttrib(n,"src",AScgiloc+'?sscr='+encodeURIComponent( ems[i].getAttribute("sscr")));
